  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { name: 'description', content: 'Website of Iqbal Perkasa, a full-stack engineer from Indonesia.' },
        { property: 'og:title', content: 'Iqbal Perkasa' },
        { property: 'og:description', content: 'Website of Iqbal Perkasa, a full-stack engineer from Indonesia.' },
