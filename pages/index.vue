  ...
  <main class="container flex flex-col gap-16 my-24">
    <header class="flex gap-6 items-center">
      ...
      <!-- <nav class="flex content-center">
        <nuxt-link class="text-md text-stone-400 hover:text-black active:bg-stone-100 transition-colors rounded-md p-4 cursor-pointer leading-none">Contact</nuxt-link>
      </nav> -->
    </header>
    ...
    <section class="flex gap-4 items-center">
      ...
      <a href="https://iqbalperkasa.super.site" target="_blank" class="border-2 border-transparent hover:border-stone-300 active:border-stone-400 transition-colors py-3 px-4 rounded-lg font-medium">Portfolio <Icon name="gravity-ui:arrow-up-right-from-square" class="align-middle mb-1 ml-1" size="18" /></a>
    </section>
    <section>
    ...
    <!-- <blockquote class="twitter-tweet">
      <a href="https://twitter.com/anonjawa/status/1824652219935007049"></a>
    </blockquote> -->
  </main>
</template>
...
const email = 'iqbal@iqbalperkasa.com';
